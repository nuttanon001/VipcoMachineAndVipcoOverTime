        ...
        public async Task<IActionResult> TaskMachineWaitAndProcess([FromBody] OptionScheduleViewModel Schedule)
        {
            ...
            try
            {
                ...
                if (Schedule != null)
                {
                    ...
                    {
                        QueryData = QueryData.Where(x =>
                            x.JobCardDetail.JobCardMaster.ProjectCodeDetail.ProjectCodeMasterId == Schedule.JobNo);
                    }
                    // Option Level
                    if (Schedule.Level2.HasValue)
                    {
                        QueryData = QueryData.Where(x =>
                            x.JobCardDetail.JobCardMaster.ProjectCodeDetail.ProjectCodeDetailId == Schedule.Level2);
                    }
